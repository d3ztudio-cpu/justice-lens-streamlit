"""Legacy Flask app (kept for reference).

This repository's Streamlit entrypoint is `app.py` (see new file), and this
legacy Flask demo has been moved to `legacy_flask_app.py`.
"""
